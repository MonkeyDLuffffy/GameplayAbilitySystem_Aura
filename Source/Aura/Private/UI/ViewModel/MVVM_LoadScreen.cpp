...
void UMVVM_LoadScreen::NewSlotButtonPressed(int32 Slot, const FString& EnterName)
{
	...
	LoadSlot->SetPlayerName(EnterName);
...
void UMVVM_LoadScreen::SelectSlotButtonPressed(int32 Slot)
{
	...
	for (TTuple<signed int, UMVVM_LoadSlot*> LoadSlot : LoadSlots)
	{
...
void UMVVM_LoadScreen::LoadData()
{
	...
	for (TTuple<signed int, UMVVM_LoadSlot*> LoadSlot : LoadSlots)
	{
		...
		//LoadSlot.Value->SetWidgetSwitcherIndex.Broadcast(SaveObject->SwitcherIndex);
